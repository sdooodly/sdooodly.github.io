            ...
            {visibleProjects.map((project, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 pointer-events-none" style={{
                    background: 'linear-gradient(to top, rgba(10,10,20,0.97) 0%, rgba(10,10,20,0.0) 60%)'
                  }} />
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-bold text-text text-center drop-shadow-lg mb-0" style={{ zIndex: 2 }}>{project.title}</h3>
                  </div>
                </div>
              );
            })}
