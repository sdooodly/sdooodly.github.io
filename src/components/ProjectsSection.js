              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 pointer-events-none" style={{
                    background: 'linear-gradient(to top, rgba(10,10,20,0.82) 60%, rgba(10,10,20,0.0) 100%)'
                  }} />
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-bold text-text text-center drop-shadow-lg mb-0">{project.title}</h3>
                  </div>
                </div>
              );
            })}
