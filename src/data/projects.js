export const featuredProjects = [
  {
    title: 'Sdooworks',
    description: 'Art portfolio showcasing acrylic, oil, and watercolour paintings with a gallery lightbox and particle effects.',
    techStack: ['HTML', 'CSS', 'JavaScript', 'Three.js'],
    githubLink: 'https://github.com/sdooodly/sdooworks',
    liveLink: 'https://sdooodly.github.io/sdooworks/',
  ...
  {
    title: 'Etch-a-Sketch',
    description: 'An interactive drawing app inspired by the classic Etch-a-Sketch toy.',
    techStack: ['HTML', 'CSS', 'JavaScript'],
...
export const otherProjects = [
  ...
  {
    title: 'CRUD MVC',
    githubLink: 'https://github.com/sdooodly/crud-mvc',
    techStack: ['C#', '.NET MVC', 'Entity Framework'],
    description: 'Full CRUD app with MVC pattern',
  },
  {
